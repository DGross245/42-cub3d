...
/*   Updated: 2023/02/19 18:17:01 by dgross           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((cube->data.map[(int)(tmp_x + 0.2)][(int)(tmp_y + 0.2)] == '3'
		&& cube->data.map[(int)(tmp_x)][(int)(tmp_y)] != '1')
		|| (cube->data.map[(int)(tmp_x - 0.2)][(int)(tmp_y - 0.2)] == '3'
		&& cube->data.map[(int)(tmp_x)][(int)(tmp_y)] != '1')
		|| (cube->data.map[(int)(tmp_x + 0.2)][(int)(tmp_y - 0.2)] == '3'
		&& cube->data.map[(int)(tmp_x + 0.2)][(int)(tmp_y - 0.2)] == '1')
		|| (cube->data.map[(int)(tmp_x - 0.2)][(int)(tmp_y + 0.2)] == '3'
		&& cube->data.map[(int)(tmp_x - 0.2)][(int)(tmp_y + 0.2)] == '1'))
		return ('0');
